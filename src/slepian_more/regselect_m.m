function XY=regselect_m(regn,c11,cmn,xunt,res,buf,ofs)
...
if exist(fnpl,'file')==2
  ...
  if res==0
    ...
    if strcmp(regn(1:4),'line')
        % Do not close the contour because of the line
    else
...
%         inout='outPlusInterior';
    ...
    % m maintain main areas of 'in' buffer

%     figure
%     plot(XY(:,1),XY(:,2),'r');

%     if buf < 0 & sum(isnan(XY(:,2))) > 1
