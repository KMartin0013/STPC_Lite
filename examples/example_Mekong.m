% EXAMPLE_YANGTZE  Example: Yangtze River basin case
%
% Usage:
%   Run in MATLAB:
%       examples/example_yangtze
%
% Description:
...
config.TH_ori        = 'mekong'; % the name of your study region 
config.areaName      = config.TH_ori; % the name of your study region
config.landOrOcean   = 'land'; % it's for land or ocean or ice? If for ocean, GAD component will be restored and inverted barameter (IB) correction will be calcualted (you can optionally add it to achieve mass sea level). 
config.c11cmn        = [85.5 39.5 114.5 0.5];  % regional boundary [lon_lower lat_upper lon_upper lat_lower]
