...
config.TH_ori        = 'yangtze'; % the name of your study region 
config.areaName      = config.TH_ori; % the name of your study region
config.landOrOcean   = 'land'; % it's for land or ocean? If for ocean, GAD component will be restored and inverted barameter (IB) correction will be calcualted (you can optionally add it to achieve mass sea level). 
config.c11cmn        = [85.5 39.5 124.5 20.5];  % regional boundary [lon_lower lat_upper lon_upper lat_lower]
