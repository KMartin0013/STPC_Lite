% EXAMPLE_SCS  Example: South China Sea case
%
% Usage:
%   Run in MATLAB:
%       examples/example_SCS
%
% Description:
...
config.TH_ori        = 'SCSpTH'; % the name of your study region 
config.areaName      = config.TH_ori; % the name of your study region
config.landOrOcean   = 'ocean'; % it's for land or ocean? If for ocean, GAD component will be restored and inverted barameter (IB) correction will be calcualted (you can optionally add it to achieve mass sea level). 
config.c11cmn        = [95.5 29.5 124.5 -4.5];  % regional boundary [lon_lower lat_upper lon_upper lat_lower]
